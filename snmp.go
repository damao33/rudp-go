...
type Snmp struct {
	...
	rudpInErrors     uint64 // packet iput errors reported from rudp
	InPkts           uint64 // incoming packets count
	OutPkts          uint64 // outgoing packets count
	InSegs           uint64 // incoming rudp segments
	OutSegs          uint64 // outgoing rudp segments
...
func (s *Snmp) Copy() *Snmp {
	...
	d.rudpInErrors = atomic.LoadUint64(&s.rudpInErrors)
...
func (s *Snmp) Reset() {
	...
	atomic.StoreUint64(&s.rudpInErrors, 0)
...
// DefaultSnmp is the global rudp connection statistics collector
